...
mainController.index = function (req, res) {
  ...
  settingsUtil.getSettings(function (err, s) {
    ...
    content.bottom = 'VPSie Helpdesk v' + pkg.version
    ...
    user.save(function (err, savedUser) {
      ...
      email
        ...
        .then(function (html) {
          const mailOptions = {
            to: savedUser.email,
            subject: '[VPSie] Account Recovery',
            html: html,
    ...
    user.save(function (err, savedUser) {
      ...
      async.waterfall(
        ...
        function (err, template) {
          ...
          let subject = '[VPSie] Password Reset Request'
      ...
      user.save(function (err, updated) {
        ...
        email
          ...
          .then(function (html) {
            const mailOptions = {
              to: updated.email,
              subject: '[VPSie] Two-Factor Authentication Removed!',
              html: html,
              generateTextFromHTML: true
            }
